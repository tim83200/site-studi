...
K:"ytp-mdx-popup-dialog",V:{role:"dialog"},U:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",U:[{D:"div",K:"ytp-mdx-popup-title",ma:"Vous \u00eates d\u00e9connect\u00e9"},{D:"div",K:"ytp-mdx-popup-description",ma:"Les vid\u00e9os que vous visionnez peuvent \u00eatre ajout\u00e9es \u00e0 l'historique des vid\u00e9os regard\u00e9es sur votre t\u00e9l\u00e9viseur et avoir une influence sur les recommandations qui vous sont faites. Pour \u00e9viter ce probl\u00e8me, annulez et connectez-vous \u00e0 YouTube sur un ordinateur."},
{D:"div",K:"ytp-mdx-privacy-popup-buttons",U:[{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],ma:"Annuler"},{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],ma:"Confirmer"}]}]}]});this.i=new g.JK(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.S(this.cancelButton,"click",this.j);this.S(this.confirmButton,"click",this.u)},N9=function(a){g.W.call(this,{D:"div",
...
b=g.V(b,128)?g.dH("Erreur sur $RECEIVER_NAME",c):b.Gc()||g.V(b,4)?g.dH("Lecture sur $RECEIVER_NAME",c):g.dH("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Ma("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.pP.call(this,"Lire sur",0,a,b);
...
break;case -1:this.Wb(new g.JI(64));break;case -1E3:this.Wb(new g.JI(128,{errorCode:"mdx.remoteerror",errorMessage:"Cette vid\u00e9o ne peut pas \u00eatre visionn\u00e9e \u00e0 distance.",zE:2}))}a=a9(this.Vb).trackData;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,H0a(this,a));a=a9(this.Vb);-1===a.volume||Math.round(this.G.getVolume())===a.volume&&this.G.isMuted()===a.muted||this.W.isActive()||this.LP()}else G0a(this)};
...
O9.prototype.xj=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.Uo[a].name};
