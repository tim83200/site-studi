...
var O="undefined"!=typeof Symbol&&"undefined"!=typeof Symbol.hasInstance;function P(a){var b=da;b=void 0===b?ea:b;return fa(a,b)}
function ha(a,b){if(null!=a){if(Array.isArray(a))a=fa(a,b);else if(L(a)){var c={},d;for(d in a)c[d]=ha(a[d],b);a=c}else a=b(a);return a}}
function fa(a,b){for(var c=a.slice(),d=0;d<c.length;d++)c[d]=ha(c[d],b);Array.isArray(a)&&J(a)&1&&K(c);return c}
function da(a){if(a&&"object"==typeof a&&a.toJSON)return a.toJSON();a:switch(typeof a){case "number":a=isFinite(a)?a:String(a);break a;case "object":if(a&&!Array.isArray(a)&&H&&null!=a&&a instanceof Uint8Array){var b;"object"!=typeof a||a&&Array.isArray(a);void 0===b&&(b=0);if(!G){G={};for(var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),d=["+/=","+/","-_=","-_.","-_"],h=0;5>h;h++){var k=c.concat(d[h].split(""));F[h]=k;for(var m=0;m<k.length;m++){var f=k[m];void 0===
G[f]&&(G[f]=m)}}}b=F[b];c=Array(Math.floor(a.length/3));d=b[64]||"";for(h=k=0;k<a.length-2;k+=3){var e=a[k],g=a[k+1];f=a[k+2];m=b[e>>2];e=b[(e&3)<<4|g>>4];g=b[(g&15)<<2|f>>6];f=b[f&63];c[h++]=""+m+e+g+f}m=0;f=d;switch(a.length-k){case 2:m=a[k+1],f=b[(m&15)<<2]||d;case 1:a=a[k],c[h]=""+b[a>>2]+b[(a&3)<<4|m>>4]+f+d}a=c.join("")}}return Array.isArray(a)?P(a):a}
function ea(a){return H&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
;var ia;function Q(a,b,c){var d=ia;ia=null;a||(a=d);d=this.constructor.j;a||(a=d?[d]:[]);this.g=(d?0:-1)-(this.constructor.g||0);this.m=void 0;this.i=a;a:{d=this.i.length;a=d-1;if(d&&(d=this.i[a],L(d))){this.j=a-this.g;this.l=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.g),this.l=void 0):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.j)a+=this.g,(d=this.i[a])?Array.isArray(d)&&K(d):this.i[a]=M;else{d=this.l||(this.l=this.i[this.j+this.g]={});var h=d[a];h?Array.isArray(h)&&
K(h):d[a]=M}}
Q.prototype.toJSON=function(){return P(this.i)};
Q.prototype.toString=function(){return this.i.toString()};function R(){Q.apply(this,arguments)}
B(R,Q);function ja(){var a={};Object.defineProperties(R,(a[Symbol.hasInstance]={value:Object[Symbol.hasInstance],configurable:!1,writable:!1,enumerable:!1},a))}
O&&ja();function ka(a,b){var c=this.g,d=!0;d=void 0===d?!1:d;N(a);a.m||(a.m={});var h=b?b.i:b;a.m[c]=b;b=d;b=void 0===b?!1:b;N(a);c<a.j&&!b?a.i[c+a.g]=h:(a.l||(a.l=a.i[a.j+a.g]={}))[c]=h;return a}
;function S(){R.apply(this,arguments)}
B(S,R);function la(){var a={};Object.defineProperties(S,(a[Symbol.hasInstance]={value:Object[Symbol.hasInstance],configurable:!1,writable:!1,enumerable:!1},a))}
O&&la();var T=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ma(a){return a?decodeURI(a):a}
;function U(a){S.call(this,a,1)}
B(U,S);function V(a){S.call(this,a)}
B(V,S);var na=new function(a){this.g=a;this.j=ka}(406606992,V);function oa(){V.apply(this,arguments)}
B(oa,V);var W,X,Y,Z=D.window,pa=(null===(W=null===Z||void 0===Z?void 0:Z.yt)||void 0===W?void 0:W.config_)||(null===(X=null===Z||void 0===Z?void 0:Z.ytcfg)||void 0===X?void 0:X.data_)||{},qa=(null===(Y=null===Z||void 0===Z?void 0:Z.ytcfg)||void 0===Y?void 0:Y.obfuscatedData_)||[];function ra(){U.apply(this,arguments)}
B(ra,U);var sa=new ra(qa),ta=pa.EXPERIMENT_FLAGS;if(!ta||!ta.jspb_i18n_extension){var ua=new oa;na.j(sa,ua)}E("yt.config_",pa);E("yt.configJspb_",qa);Object.freeze(["js-httpswwwgoogleanalyticscomanalyticsjs","js-chromeextensionpkedcjkdefgpdelpbcmbmeomcjbeemfm","video-","js-http","css-http"]);
var va=Object.freeze("document.appendChild document.body.appendChild document.querySelector document.querySelectorAll history.back history.go".split(" ")),wa=Object.freeze("fonts.googleapis.com s0.2mdn.net securepubads.g.doubleclick.net ssl.google-analytics.com static.doubleclick.net www.google-analytics.com www.googletagservices.com www.youtube.com youtube.com".split(" ")),xa=Object.freeze(["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl","enhhojjnijigcajfphajepfemndkmdlo"]),
ya=Object.freeze(".corp.google.com .googlevideo.com .ytimg.com .google.com .googlesyndication.com .gstatic.com .prod.google.com .google.ru".split(" ")),za=Object.freeze(["chrome-extension","safari-extension","safari-resource","opera"]);function Aa(){return va.map(function(a){return Ba(a)}).filter(function(a){return!!a})}
function Ba(a){var b=a.split(".");a=b[b.length-1];b=b.reduce(function(c,d){return c&&c[d]},window);
...
function Ca(a){var b=a.match(T)[1]||null;return za.some(function(c){return b==c})}
function Da(a){var b=ma(a.match(T)[3]||null);return!b||Ca(a)?!0:wa.some(function(c){return b==c})||ya.some(function(c){return b.endsWith(c)})}
function Ea(a){if(!Ca(a))return null;var b=ma(a.match(T)[3]||null);return b?xa.some(function(c){return b==c})?null:b:null}
function Fa(){var a=new Set;[].concat(w(document.querySelectorAll("script"))).forEach(function(b){b.src&&!Da(b.src)&&a.add(b.src)});
[].concat(w(document.querySelectorAll("link[href]"))).forEach(function(b){"alternate"==b.rel||Da(b.href)||a.add(b.href)});
return[].concat(w(a)).sort()}
function Ga(){var a=new Set;[].concat(w(document.querySelectorAll("script"))).forEach(function(b){b.src&&(b=Ea(b.src))&&a.add(b)});
return[].concat(w(a)).sort()}
;E("ytbin.polymer.shared.lib.tampering.info",function(){var a=Fa(),b=Aa(),c=Ga(),d=[];c.length&&d.push("extensions",c);a.length&&d.push("suspiciousIncludes",a);b.length&&d.push("suspiciousApis",b);return d.length?d:null});}).call(this);
